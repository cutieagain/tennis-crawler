...
public class Statistics {
    ...
    private int awaySecondServeScored;
    private int awaySecondServeTotal;
    private int awaySecondServeAccuracy;
    private int homeBreakPointsScored;
    private int homeBreakPointsTotal;
    private int homeBreakPointsAccuracy;
    ...
    public void setHomeAces(int homeAces) {
     ...
     public int getHomeAces() {
         return homeAces;
     }

    public void setAwayAces(int awayAces) {
         this.awayAces = awayAces;
     }
     public int getAwayAces() {
         return awayAces;
     }

    public void setHomeDoubleFaults(int homeDoubleFaults) {
         this.homeDoubleFaults = homeDoubleFaults;
     }
     public int getHomeDoubleFaults() {
         return homeDoubleFaults;
     }

    public void setAwayDoubleFaults(int awayDoubleFaults) {
         this.awayDoubleFaults = awayDoubleFaults;
     }
     public int getAwayDoubleFaults() {
    ...
    public void setHomeFirstServeScored(int homeFirstServeScored) {
         this.homeFirstServeScored = homeFirstServeScored;
     }
     public int getHomeFirstServeScored() {
         return homeFirstServeScored;
     }

    public void setHomeFirstServeTotal(int homeFirstServeTotal) {
         this.homeFirstServeTotal = homeFirstServeTotal;
     }
     public int getHomeFirstServeTotal() {
         return homeFirstServeTotal;
     }

    public void setHomeFirstServeAccuracy(int homeFirstServeAccuracy) {
         this.homeFirstServeAccuracy = homeFirstServeAccuracy;
     }
     public int getHomeFirstServeAccuracy() {
         return homeFirstServeAccuracy;
     }

    public void setAwayFirstServeScored(int awayFirstServeScored) {
         this.awayFirstServeScored = awayFirstServeScored;
     }
     public int getAwayFirstServeScored() {
         return awayFirstServeScored;
     }

    public void setAwayFirstServeTotal(int awayFirstServeTotal) {
         this.awayFirstServeTotal = awayFirstServeTotal;
     }
     public int getAwayFirstServeTotal() {
         return awayFirstServeTotal;
     }

    public void setAwayFirstServeAccuracy(int awayFirstServeAccuracy) {
         this.awayFirstServeAccuracy = awayFirstServeAccuracy;
     }
    ...
    public void setHomeSecondServeScored(int homeSecondServeScored) {
         this.homeSecondServeScored = homeSecondServeScored;
     }
     public int getHomeSecondServeScored() {
         return homeSecondServeScored;
     }

    public void setHomeSecondServeTotal(int homeSecondServeTotal) {
         this.homeSecondServeTotal = homeSecondServeTotal;
     }
     public int getHomeSecondServeTotal() {
         return homeSecondServeTotal;
     }

    public void setHomeSecondServeAccuracy(int homeSecondServeAccuracy) {
         this.homeSecondServeAccuracy = homeSecondServeAccuracy;
     }
     public int getHomeSecondServeAccuracy() {
         return homeSecondServeAccuracy;
     }

    public void setAwaySecondServeScored(int awaySecondServeScored) {
         this.awaySecondServeScored = awaySecondServeScored;
     }
     public int getAwaySecondServeScored() {
         return awaySecondServeScored;
     }

    public void setAwaySecondServeTotal(int awaySecondServeTotal) {
         this.awaySecondServeTotal = awaySecondServeTotal;
     }
     public int getAwaySecondServeTotal() {
         return awaySecondServeTotal;
     }

    public void setAwaySecondServeAccuracy(int awaySecondServeAccuracy) {
         this.awaySecondServeAccuracy = awaySecondServeAccuracy;
     }
     public int getAwaySecondServeAccuracy() {
         return awaySecondServeAccuracy;
     }

    public void setHomeBreakPointsScored(int homeBreakPointsScored) {
         this.homeBreakPointsScored = homeBreakPointsScored;
     }
     public int getHomeBreakPointsScored() {
         return homeBreakPointsScored;
     }

    public void setHomeBreakPointsTotal(int homeBreakPointsTotal) {
         this.homeBreakPointsTotal = homeBreakPointsTotal;
     }
     public int getHomeBreakPointsTotal() {
         return homeBreakPointsTotal;
     }

    public void setHomeBreakPointsAccuracy(int homeBreakPointsAccuracy) {
         this.homeBreakPointsAccuracy = homeBreakPointsAccuracy;
     }
     public int getHomeBreakPointsAccuracy() {
         return homeBreakPointsAccuracy;
     }

    public void setAwayBreakPointsScored(int awayBreakPointsScored) {
         this.awayBreakPointsScored = awayBreakPointsScored;
     }
     public int getAwayBreakPointsScored() {
         return awayBreakPointsScored;
     }

    public void setAwayBreakPointsTotal(int awayBreakPointsTotal) {
         this.awayBreakPointsTotal = awayBreakPointsTotal;
     }
     public int getAwayBreakPointsTotal() {
         return awayBreakPointsTotal;
     }

    public void setAwayBreakPointsAccuracy(int awayBreakPointsAccuracy) {
         this.awayBreakPointsAccuracy = awayBreakPointsAccuracy;
     }
     public int getAwayBreakPointsAccuracy() {
    ...
    public void setHomeServiceGamesScored(int homeServiceGamesScored) {
     ...
     public int getHomeServiceGamesScored() {
         return homeServiceGamesScored;
     }

    public void setHomeServiceGamesTotal(int homeServiceGamesTotal) {
         this.homeServiceGamesTotal = homeServiceGamesTotal;
     }
     public int getHomeServiceGamesTotal() {
         return homeServiceGamesTotal;
     }

    public void setHomeServiceGamesAccuracy(int homeServiceGamesAccuracy) {
         this.homeServiceGamesAccuracy = homeServiceGamesAccuracy;
     }
     public int getHomeServiceGamesAccuracy() {
         return homeServiceGamesAccuracy;
     }

    public void setAwayServiceGamesScored(int awayServiceGamesScored) {
         this.awayServiceGamesScored = awayServiceGamesScored;
     }
     public int getAwayServiceGamesScored() {
         return awayServiceGamesScored;
     }

    public void setAwayServiceGamesTotal(int awayServiceGamesTotal) {
         this.awayServiceGamesTotal = awayServiceGamesTotal;
     }
     public int getAwayServiceGamesTotal() {
         return awayServiceGamesTotal;
     }

    public void setAwayServiceGamesAccuracy(int awayServiceGamesAccuracy) {
         this.awayServiceGamesAccuracy = awayServiceGamesAccuracy;
     }
     public int getAwayServiceGamesAccuracy() {
    ...
    public void setHomeReceiverPointsScored(int homeReceiverPointsScored) {
     ...
     public int getHomeReceiverPointsScored() {
         return homeReceiverPointsScored;
     }

    public void setHomeReceiverPointsTotal(int homeReceiverPointsTotal) {
         this.homeReceiverPointsTotal = homeReceiverPointsTotal;
     }
     public int getHomeReceiverPointsTotal() {
         return homeReceiverPointsTotal;
     }

    public void setHomeReceiverPointsAccuracy(int homeReceiverPointsAccuracy) {
         this.homeReceiverPointsAccuracy = homeReceiverPointsAccuracy;
     }
     public int getHomeReceiverPointsAccuracy() {
         return homeReceiverPointsAccuracy;
     }

    public void setAwayReceiverPointsScored(int awayReceiverPointsScored) {
         this.awayReceiverPointsScored = awayReceiverPointsScored;
     }
     public int getAwayReceiverPointsScored() {
         return awayReceiverPointsScored;
     }

    public void setAwayReceiverPointsTotal(int awayReceiverPointsTotal) {
         this.awayReceiverPointsTotal = awayReceiverPointsTotal;
     }
     public int getAwayReceiverPointsTotal() {
         return awayReceiverPointsTotal;
     }

    public void setAwayReceiverPointsAccuracy(int awayReceiverPointsAccuracy) {
         this.awayReceiverPointsAccuracy = awayReceiverPointsAccuracy;
     }
